...
- `#[prologue_macro(macro1, macro2, ...)]` - Injects a list of macros before the decorated function.
- `#[epilogue_macro(macro1, macro2, ...)]` - Injects a list of macros after the decorated function.
